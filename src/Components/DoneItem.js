...
const DoneItem = ({ doneTaskData, popUpTaskBox, checkFunc, checkListCurID }) => {
  // console.log(doneTaskData)
        ...
        return (
          <div className={styles.itemMainBox} key={index}>
            ...
            <div className={styles.chooseTaskStatus}>
              ...
              <div>{item.dueDate===null?'' : <span className={styles.dateStatus} style={{ backgroundColor: '#63c05b' }}>{formatDate(item.dueDate)}</span> }
              </div>
